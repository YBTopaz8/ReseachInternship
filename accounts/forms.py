...
class EditProfileForm(UserChangeForm):
    ...
    class Meta:
       ...
       # TO EXCLUDE FIELDS exclude = ('groups','is_staff','is_superuser', 'is_active', 'groups','user_permissions','date_joined','password','last_login')
...
class SignUpForm(UserCreationForm):
    ...
    #to stylize the form inputs with bootstrap
